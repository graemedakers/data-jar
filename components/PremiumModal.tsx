            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
                    ...
                    >
                        ...
                        {/* Close button removed to force payment */}
                        ...
                        <div className="p-8 flex flex-col items-center text-center relative z-10">
                            ...
                            <h2 className="text-3xl font-black text-white mb-2">Activate Your Jar</h2>
                            <p className="text-slate-300 mb-8">
                                One-time fee to create your jar and start spicing up your relationship.
                            </p>
                            ...
                            <div className="space-y-4 w-full mb-8 text-left bg-white/5 p-6 rounded-xl border border-white/10">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-white font-medium">Create Your Shared Jar</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="p-1 bg-green-500/20 rounded-full">
                                        <Check className="w-4 h-4 text-green-400" />
                                    </div>
                                    <span className="text-white font-medium">Unlimited Date Ideas</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="p-1 bg-green-500/20 rounded-full">
                                        <Check className="w-4 h-4 text-green-400" />
