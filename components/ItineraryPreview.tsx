...
export function ItineraryPreview({ itinerary }: ItineraryPreviewProps) {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="relative border-l-2 border-slate-700 ml-4 space-y-8 pl-8 py-2 text-left">
            ...
            {(itinerary.schedule.length >= 3) && (
                <a
                    ...
                    className="block w-full py-3 bg-blue-500/10 hover:bg-blue-500/20 text-blue-300 hover:text-blue-200 border border-blue-500/20 rounded-xl text-center font-medium transition-colors flex items-center justify-center gap-2"
                >
