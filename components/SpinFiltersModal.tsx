                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-xl font-bold text-white">Filter Your Spin</h2>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Cost Filter */}
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-300">Max Cost</label>
                                <div className="grid grid-cols-4 gap-2">
                                    {['FREE', '$', '$$', '$$$'].map((cost) => (
                                        <button
                                            key={cost}
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-300">Max Activity Level</label>
                            ...
                            {/* Time of Day Filter */}
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-300">Time of Day</label>
                                <div className="grid grid-cols-3 gap-2">
