    ...
    return (
        <>
            <button
                ...
                className="fixed bottom-6 right-6 z-40 p-3 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 rounded-full shadow-lg transition-all hover:scale-110 group"
                title="Help & Manual"
            >
